...
nivel6 = Juego([["obstaculo", "obstaculo", "obstaculo", "obstaculo", "obstaculo", "obstaculo", "obstaculo", "obstaculo", "obstaculo", "obstaculo", "fin", "obstaculo"],
...
solucion = b_optima_nueva.buscar(nivel6)
...
solucion = b_anchura.buscar(nivel6)
print("Movimientos realizaados")
i = 1
for movimiento in solucion:
    print(i,". ",movimiento)
...
solucion = b_profundidad.buscar(nivel6)
print("Movimientos realizaados")
i = 1
for movimiento in solucion:
    print(i,". ",movimiento)
...
solucion = b_a_estrella.buscar(nivel6)
print("Movimientos realizaados")
i = 1
for movimiento in solucion:
    print(i,". ",movimiento)
