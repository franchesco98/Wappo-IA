...
nivel1 = Juego([[10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, "obstaculo"],
...
solucion = b_optima_nueva.buscar(nivel1)
...
solucion = b_anchura.buscar(nivel1)
print("Movimientos realizaados")
i = 1
for movimiento in solucion:
    print(i,". ",movimiento)
...
solucion = b_profundidad.buscar(nivel1)
print("Movimientos realizaados")
i = 1
for movimiento in solucion:
    print(i,". ",movimiento)
...
solucion = b_a_estrella.buscar(nivel1)
print("Movimientos realizaados")
i = 1
for movimiento in solucion:
    print(i,". ",movimiento)
