...
nivel0 = Juego([[10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10,"obstaculo"],
                      ["obstaculo", 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, "obstaculo", "obstaculo"],
                      [10, "obstaculo", 10, 10, 10, 10, 10, 10, 10, 10, 10, "obstaculo","obstaculo"],
                      [10, "obstaculo", 10, 10, 10, 10, 10, 10, 10, 10, 10, "obstaculo", "obstaculo"],
                      [10, "obstaculo", 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, "fin"],
                      [10, "obstaculo", 10, 10, 10, 10, 10, 10, 10, 10, 10, "obstaculo", "obstaculo"],
                      [10, "obstaculo", 10, 10, 10, 10, 10, 10, 10, 10, 10, "obstaculo", "obstaculo"],
                      [10, "obstaculo", 10, 10, 10, 10, 10, 10, 10, 10, 10, "obstaculo", "obstaculo"],
                      [10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, "obstaculo", "obstaculo"],
                      [10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, "obstaculo", "obstaculo"],
                      [10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, "obstaculo", "obstaculo"],
                      [10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, "obstaculo", "obstaculo"]], monstruo, jugador);


print("Busqueda optima")
b_optima_nueva = busqee.BusquedaOptima()
solucion = b_optima_nueva.buscar(nivel0)
...
solucion = b_anchura.buscar(nivel0)
print("Movimientos realizados")
i = 1
for movimiento in solucion:
    print(i,". ",movimiento)
...
solucion = b_profundidad.buscar(nivel0)
print("Movimientos realizados")
i = 1
for movimiento in solucion:
    print(i,". ",movimiento)
...
solucion = b_a_estrella.buscar(nivel0)
print("Movimientos realizados")
i = 1
for movimiento in solucion:
    print(i,". ",movimiento)
